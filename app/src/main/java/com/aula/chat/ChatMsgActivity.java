...
public class ChatMsgActivity extends AppCompatActivity {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(message.trim().length()>0){
                    ...
                    Toast.makeText(ChatMsgActivity.this, "Não pode enviar em branco", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        dbReferenceSender.child(messageId).setValue(messageModel)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(ChatMsgActivity.this, "Envio da mensagem!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ChatMsgActivity.this, "Falha ao mandar mensagem!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.logout){
            ...
            startActivity(new Intent(ChatMsgActivity.this, LoginActivity.class));
            finish();
            return true;
        }
        return false;
