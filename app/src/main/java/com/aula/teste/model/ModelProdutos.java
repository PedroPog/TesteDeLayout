...
public class ModelProdutos implements Serializable {
    ...
    private String descricao = "PRODUTO TESTE";
    ...
    private String cest = "0000000";
    private String cfop = "5.102";
    private String status = "A";
    private int idunidade = 1;
    private String undSigla= "UN";
    private String cor = "#ff7f50";
    private String quntEstoque="0";
    private String imagem = "0";
    ...
    public String getQuntEstoque() {
        return quntEstoque;
    }

    public void setQuntEstoque(String quntEstoque) {
        this.quntEstoque = quntEstoque;
    }
